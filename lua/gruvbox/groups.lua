...
M.setup = function()
  ...
  local groups = {
    ...
    SpellBad = { fg = colors.red, bg = colors.bg0, },
    SpellLocal = { link = "GruvboxAquaUnderline" },
    SpellRare = { link = "GruvboxPurpleUnderline" },
    Whitespace = { fg = colors.bg2 },
    -- LSP Diagnostic
    DiagnosticError = { fg = colors.neutral_red },
    DiagnosticSignError = { fg = colors.neutral_red, bold = config.bold },
    DiagnosticUnderlineError = { link = "GruvboxRedUnderline" },
    DiagnosticWarn = { fg = colors.neutral_yellow },
    DiagnosticSignWarn = { fg = colors.neutral_yellow, bold = config.bold },
    DiagnosticUnderlineWarn = { link = "GruvboxYellowUnderline" },
    DiagnosticInfo = { fg = colors.neutral_blue },
    DiagnosticSignInfo = { fg = colors.neutral_blue, bold = config.bold },
    DiagnosticUnderlineInfo = { link = "GruvboxBlueUnderline" },
    DiagnosticHint = { fg = colors.neutral_blue },
    DiagnosticSignHint = { fg = colors.neutral_blue, bold = config.bold },
    ...
    -- ident blankline
    IndentBlanklineIndent = { fg = colors.bg1 },
